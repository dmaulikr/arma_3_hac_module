 ...
 * Returns:
 * Arguments:
 * Example: _bArr = [_tgtPos,RydHQ_ArtG,"SADARM",6,leaderHQ] call RYD_ArtyMission;
 */
if (isNil("RYD_ArtyMission")) then {
	RYD_ArtyMission = {
			...
			if (_ammo in ["ILLUM","SMOKE"]) then {
				...
				[_battery,_pos,_template,_FO] spawn	{
					...
					if (_ammo == "ILLUM") then {
						...
						//_i2 = [_pos2,(random 1000),"markArty","ColorRed","ICON","mil_dot",_ammo,"",[0.75,0.75]] call RYD_Mark;
						//_i3 = [_pos3,(random 1000),"markArty","ColorRed","ICON","mil_dot",_ammo,"",[0.75,0.75]] call RYD_Mark;
